...
export class ConfigService {
  ...
  private _upload_user_photo = 'http://localhost:8085' + '/upload'
  ...
  private _upload_post_img = 'http://localhost:8086' + '/upload'
  ...
  //admin start
    ...
    private _images = 'http://localhost:8089' + '/images/';
  ...
  //story start
    private _upload_story_picture = 'http://localhost:8083' + '/upload'
